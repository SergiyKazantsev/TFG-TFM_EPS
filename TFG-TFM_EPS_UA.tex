...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Título y subtítulo
\newcommand{\titulo}{Aplicación multiplataforma para el Entrenamiento de Oído}
\newcommand{\subtitulo}{Desarrollo de un entrenador de oído multiplataforma para mejorar las capacidades auditivas}
% Datos del autor
\newcommand{\miNombre}{Sergiy Kazantsev}
% Determinar género para etiquetas Autore/Autora/Autor (nb o en blanco,f,m)
\newcommand{\miGenero}{m}
\newcommand{\miEmail}{sk123@alu.ua.es}
% Datos del tutor/es
% Si no hay tutorB, comentar tutorB y dptoB para que la etiqueta sea Tutor:
\newcommand{\miTutor}{Miguel Ángel Teruel Martínez}
\newcommand{\miTutorB}{Álvaro Navarro López-Menchero}

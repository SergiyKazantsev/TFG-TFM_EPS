...
\begin{enumerate}
	...
	\item \textbf{006 Servicio de Evaluación de Respuestas:} Como usuario, quiero que mis respuestas sean comparadas con la solución y evaluadas. \textbf{2 puntos de historia} \\
	{\small \textit{Criterios de aceptación:}}
	\begin{itemize}
	...
	\item \textbf{007 Modulo de internacionalización i18N:} Como usuario, quiero que la aplicación ofrezca la posibilidad de cambiar el idioma para adaptarse a mi idioma nativo. \textbf{1 punto de historia} \\
	{\small \textit{Criterios de aceptación:}} \\
...
Esta historia tenía como objetivos refinar la página de login y implementar la del registro y, por otro lado, finalizar la funcionalidad de la edición de perfil del usuario.

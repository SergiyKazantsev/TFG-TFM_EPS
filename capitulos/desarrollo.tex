...
\begin{enumerate}
	...
	{\small \textit{Criterios de aceptación:}} \\
	Se han incluido tres módulos de traducciónes: Inglés, Castellano, Ucraniano.
\end{enumerate}
...
Se ha generado un script de Python que permite generar notas a partir de un fichero Soundfont utilizando el API de MIDI.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.65\linewidth]{archivos/sprint1}
...
\begin{enumerate}
	...
	{\small \textit{Criterios de aceptación:}} \\
	Se ha una sección para el reconocimiento de la altura relativa de las notas. El intento se registra en la parte de Backend y se califica.
	...
	\item \textbf{010 Feedback visual y vibraciones} Como usuario, quiero que la aplicación haga uso de las herramientas del dispositivo para avisarme si he succedido o fallado. \textbf{2 puntos de historia}
	\\
	{\small \textit{Criterios de aceptación:}} \\
	Durante la realización de los ejercicios, se notifica al usuario de la calificación usando vibraciones en Android. También se usarán Toasts tanto en el navegador como Android.
	
	\item \textbf{011 Generación de sonidos avanzados con Python:} Como usuario, quiero que la aplicación reproduzca los sonidos sin errores para que yo pueda entrenarme. \textbf{1 punto de historia} \\
	{\small \textit{Criterios de aceptación:}} \\
	Los sonidos se guardan en los assets y se reproducen sin errores en los ejercicios.
\end{enumerate}

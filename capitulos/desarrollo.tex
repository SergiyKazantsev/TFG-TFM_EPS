...
\begin{enumerate}
	...
	\item \textbf{024 - Mejoras y arreglos de bugs:} Como usuario, quiero que la aplicación sea lo más intuitiva posible y que no haya errores ni bugs que afecten a mi experiencia. \textbf{7 puntos de historia} \\
	{\small \textit{Criterios de aceptación:}} \\
	Probar y mejorar la \gls{ux} al máximo. Implica la mejora de fluidez y pruebas manuales exhaustivas.
\end{enumerate}
...
\begin{figure}[H]
	...
	\begin{subfigure}{0.35\linewidth}
		\centering
		% Wrap the command here:
		\fbox{\includegraphics[width=0.7\linewidth]{archivos/screenshot011}}
	...
	\begin{subfigure}{0.35\linewidth}
		\centering
		% And wrap it here:
		\fbox{\includegraphics[width=0.7\linewidth]{archivos/screenshot012}}

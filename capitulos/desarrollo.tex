...
\begin{enumerate}
	\item \textbf{Walking skeleton:} Como desarrollador, quiero implementar un flujo mínimo que permita comprobar el correcto funcionamiento del programa tanto en el navegador como en Android. \textbf{7 puntos de historia} \\
	{\small \textit{Criterios de aceptación:}} \\
	Se ha creado una página sencilla en Ionic y Angular con un ToDoList (sin inicio de sesión ni comunicación con la BD). Diseñar la navegación y el perfil del usuario
	
	\item \textbf{Integración con Supabase:} Como usuario, quiero que mis datos y acciones se guarden para la siguiente sesión. Para ello tengo que poder crear mi propia cuenta y poder hacer login. \textbf{3 puntos de historia}
	\\
	{\small \textit{Criterios de aceptación:}}
	\begin{itemize}
	...
	\item \textbf{Generar sonidos MIDI con Python (básica):} Como usuario, quiero poder reproducir los sonidos y secuencias musicales correctas para entrenar mi oído. \textbf{5 puntos de historia}
	\\
	{\small \textit{Criterios de aceptación:}} \\
	Se han generado las notas de todas las escalas y se han guardado en assets de la aplicación.
	
	\item \textbf{Integración de sonidos MP3 en Ionic con Angular:} Como usuario, quiero que la aplicación reproduzca los sonidos sin errores para que yo pueda entrenarme. \textbf{1 punto de historia} \\
	{\small \textit{Criterios de aceptación:}} \\
	Los sonidos se guardan en los assets y se reproducen sin errores pulsando un botón.
	
	\item \textbf{Estructura del Backend:} Como desarrollador, quiero estructurar mi base de datos para poder organizar todas las entidades, usuarios y lecciones musicales. \textbf{5 puntos de historia} \\
	{\small \textit{Criterios de aceptación:}}
	\begin{itemize}
	...
	\item \textbf{Servicio de Evaluación de Respuestas:} Como usuario, quiero que mis respuestas sean comparadas con la solución y evaluadas. \textbf{4 puntos de historia} \\
	{\small \textit{Criterios de aceptación:}}
	\begin{itemize}

...
\begin{enumerate}[noitemsep=10pt, topsep=10pt]
	...
	\begin{itemize}
		...
		\item Crear las reglas y restricciones en la BD.
	\end{itemize}
	...
	\begin{itemize}
		...
		\item El resultado se verifica comunicándose con Supabase.
		\item El intento se registra en la BD.
	\end{itemize}
	...
	{\small \textit{Criterios de aceptación:}} \\
	Se han incluido tres módulos de traducciones:
	\begin{itemize}
		\item Castellano.
		\item Inglés.
		\item Ucraniano.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.0\linewidth]{archivos/bd.drawio.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.0\linewidth]{archivos/screenshot_supabase}
...
\begin{figure}[H]
	...
	\fbox{\includegraphics[width=1.0\linewidth]{archivos/diagrama.drawio.png}}
...
\begin{figure}[H]
	...
	\begin{subfigure}{0.30\linewidth}
		\centering
		% Wrap the command here:
		\fbox{\includegraphics[width=0.7\linewidth]{archivos/screenshot014}}
	...
	\begin{subfigure}{0.30\linewidth}
		\centering
		% And wrap it here:
		\fbox{\includegraphics[width=0.7\linewidth]{archivos/screenshot015}}
...
\begin{figure}[H]
	...
	\setlength{\fboxsep}{0pt}
	\fbox{\includegraphics[width=0.2\linewidth]{archivos/screenshot016}}
...
\begin{figure}[H]
	...
	\begin{subfigure}{0.38\linewidth}
		\centering
		% Wrap the command here:
		\fbox{\includegraphics[width=0.7\linewidth]{archivos/screenshot017}}
	...
	\begin{subfigure}{0.38\linewidth}
		\centering
		% And wrap it here:
		\fbox{\includegraphics[width=0.7\linewidth]{archivos/screenshot018}}

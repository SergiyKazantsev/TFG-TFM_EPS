...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Resultados}
Al final del sprint 4, se ha conseguido implementar todos los objetivos principales establecidos en el capítulo \ref{chap:introduccion}, Introducción, y realizar las pruebas exhaustivas necesarias para poder publicar la primera versión de la aplicación de entrenamiento de oído llamada Orcastra. Durante el desarrollo, se ha seguido una paleta constante de colores con el fin de mantener el diseño lo más coherente posible, proporcionando así la mejor experiencia de usuario para el público objetivo (estudiantes de música).
...
\begin{figure}[H]
	...
	% --- Fila 1 ---
	\begin{subfigure}[t]{0.23\linewidth} % <--- Añadido [t]
		\centering
		\fbox{\includegraphics[width=0.7\linewidth]{archivos/screenshot019}}
		\caption{Página principal} \label{fig:screenshot019}
	\end{subfigure}
	\hfill
	\begin{subfigure}[t]{0.23\linewidth} % <--- Añadido [t]
		\centering
		\fbox{\includegraphics[width=0.7\linewidth]{archivos/screenshot020}}
		\caption{Página de entrenamiento} \label{fig:screenshot020}
	\end{subfigure}
	\hfill
	\begin{subfigure}[t]{0.23\linewidth} % <--- Añadido [t]
		\centering
		\fbox{\includegraphics[width=0.7\linewidth]{archivos/screenshot021}}
		\caption{Selección de opciones del entrenador libre} \label{fig:screenshot021}
	\end{subfigure}
	
	\vspace{2em} % Aumentado un poco el espacio para que el caption largo no choque con la fila de abajo
	
	% --- Fila 2 ---
	\begin{subfigure}[t]{0.23\linewidth} % <--- Añadido [t]
		\centering
		\fbox{\includegraphics[width=0.7\linewidth]{archivos/screenshot022}}
		\caption{Modo piano} \label{fig:screenshot022}
	\end{subfigure}
	\hfill
	\begin{subfigure}[t]{0.23\linewidth} % <--- Añadido [t]
		\centering
		\fbox{\includegraphics[width=0.7\linewidth]{archivos/screenshot025}}
		\caption{Restablecimiento de contraseña} \label{fig:screenshot025}
	\end{subfigure}
	\hfill
	\begin{subfigure}[t]{0.23\linewidth} % <--- Añadido [t]
		\centering
		\fbox{\includegraphics[width=0.7\linewidth]{archivos/screenshot026}}
		\caption{Página "Sobre nosotros"} \label{fig:screenshot026}
	\end{subfigure}
	
	\vspace{1em}
	\caption{Recopilación de capturas de pantalla de las páginas de la aplicación.}
	\label{fig:grupo_evaluables}
\end{figure}

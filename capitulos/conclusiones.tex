...
Como se ha mencionado previamente, se han implementado todos los objetivos principales establecidos, que eran los ejercicios de reconocimiento de alturas, tonos, intervalos, escalas, acordes y ritmos. A la hora de establecer dichos objetivos no tenía la idea clara de cómo implementar el último tipo de ejercicio: el reconocimiento de ritmos. Inicialmente, he considerado la posibilidad de hacerlo parecido a los otros ejercicios, donde el usuario tiene varias opciones de respuesta. Sin embargo, considero una mejora sustancial la adición del dictado musical. Por otro lado, en los objetivos generales no se establecía la implementación las herramientas como el entrenamiento libre y el modo piano que finalmente se han llegado a desarrollar.
\par Por otro lado, las mejoras técnicas como el inicio de sesión con Google o la verificación con Captcha se implementaban según su disponibilidad en el framework Ionic y la posibilidad de integrarse con Supabase, por lo cual no se mencionaban en los objetivos generales.
\section{Lecciones aprendidas}
Al empezar el proyecto, tenía pocos conocimientos sobre la música y armonía, sobre la forma de estructurar una composición musical y de que consiste. Este trabajo me ha permitido aprenderlo de primera mano, haciendo la investigación necesaria con la bibliografía, tanto la proporcionada por el tutor, como la que he encontrado en bibliotecas y en Internet. Gracias a esto, me siento más cercano al mundo de la música.
\par Respecto a la parte de desarrollo, este \gls{tfg} me ha dado la posibilidad de investigar e implementar el funcionamiento de las aplicaciones multiplataforma de una forma más profunda. Adicionalmente, he aprendido varias tecnologías y APIs nuevas, como Supabase, Google Cloud, Google Workspace y Firebase (aunque este no se ha utilizado), también el funcionamiento de los servidores SMTP, OAuth con proveedores externos, la seguridad de las aplicaciones y la protección contra bots con un Captcha.
\section{Futuro de la aplicación}
En el futuro cercano tengo la intención de publicar la aplicación en Google Play, para esto se tiene que dar de alta como desarrollador en la plataforma, verificar la documentación y pagar una cuota de 25 dólares. Por otro lado, respecto la monetización de la aplicación, no tenía pensado ganar dinero a través de ella, aunque en el futuro sería viable añadir un enlace a una plataforma de donaciones como \textit{Ko-Fi} o \textit{BuyMeACoffee}, haciendo posible las donaciones voluntarias, sin cerrar ninguna funcionalidad bajo \textit{paywall}.

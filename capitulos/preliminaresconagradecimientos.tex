...
\begin{flushright}
\small\em{
Dedico este trabajo a mi familia y a mi pareja, Marharyta, que me han dado la motivación para seguir adelante y completar mis estudios.
\\
En memoria de quienes no han podido estar aquí para acompañarme, cuyos nombres no puedo mencionar y quienes permanecerán siempre en mi recuerdo.
}
\end{flushright}
\todo{Cambiar}

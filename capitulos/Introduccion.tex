...
\begin{itemize}
	...
	\item Las lecciones de aprendizaje ordenados de forma progresiva según su dificultad, y se podrán abrir una vez terminada el la lección previa. Por ejemplo, el entrenamiento del reconocimiento de los modos y escala implica un buen manejo de reconocimiento de los intervalos.
	\item Las lecciones tendrán que ser variadas segun el tipo del entrenamiento.
	\item Publicar la aplicación en un hosting y en Google Play.
\end{itemize}
...
\begin{enumerate}
	...
	\item Reconocimiento de escalas y sus modos.

...
\subsection{Octavas}
El piano dispone de 88 teclas, cada una de las cuales tiene una frecuecia determinada (desde 20 {hz} y hasta 20000 \gls{hz}). La distancia mínima en frecuencia/altura de cada tecla siempre es la misma, y se denomina "semitono". Gracias a los tonos y semitonos, se puede saber exactamente la distancia entre cada nota, por ejemplo: entre Do y Re la distancia es de un tono, entre Do y Do\musSharp{} la distancia es de un semitono (ver figura \ref{fig:octavas}).

\begin{figure}[h]
	\centering
	\includegraphics[width=1.0\textwidth]{archivos/octavas}
...
\begin{table}[ht]
	...
	\caption{Las duraciones de distintas figuras.}
	\label{tablaritmo}
\end{table}

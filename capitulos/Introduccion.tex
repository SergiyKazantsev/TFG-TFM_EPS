...
\par Este trabajo tiene como objetivo estudiar los framework multiplataforma y el proceso de desarrollo de una aplicación compatible con los navegadores Web y el sistema operativo Android.
...
La digitalización de los procesos educativos ha tenido un mayor avance durante las últimas decadas: cursos digitales, profesores, enseñanza a distancia, etc. Dentro de este proyecto, se ofrece una solución tecnológica a la cuestión de la ausencia de instrumentos y recursos en el estudiantado joven, para proporcionar un producto que permita el entrenamiento el oído sin usar el piano físico, facilitarando así los procesos la memorización y puesta en práctica de los conceptos teóricos. En los siguientes capítulos, se definirá el alcance del proyecto con el estudio previo de las tecnologías de aprendizaje de música ya existentes.

\section{Objetivos}
\label{objetivos}
Este capítulo expone los objetivos principales de este proyecto, así como los objetivos secundarios. Todos los objetivos tendrán que ser medibles, alcanzables y específicos dentro del contexto del proyecto, y la definición de los objetivos permitirá desglosar la planificación del proyecto en tareas concretas una vez que se haya empezado la implementac	ión.
...
\begin{itemize}
	...
	\item Grabar los audios para cada una de las lecciones.
	\item Incluir grabaciones de audio con el fin de proporcionar la base para el entrenamiento.
	\item Cada estudiante podrá registrarse, iniciar sesión y acceder a su perfil con el fin de visualizar y medir su progreso dentro de la aplicación.
	\item Las lecciones de aprendizaje ordenados de forma progresiva según su dificultad, y se podrán abrir una vez terminada el la lección previa. Por ejemplo, el entrenamiento del reconocimiento de escalas implica un buen manejo de reconocimiento de los intervalos.
	\item Las lecciones tendrán que ser variadas segun el tipo del entrenamiento.

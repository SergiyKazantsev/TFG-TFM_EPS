...
\end{itemize}
\par Para cada sprint se ha establecido una duración de 2 semanas, a lo largo del cual se tendrá que implementar 25 puntos de historia de usuario. Un punto de historia correspondrá a 2 horas de trabajo, aproximadamente.
\par Se han planificado 5 sprints de desarrollo para llegar a la entrega del proyecto, por lo cual:
% Definición de la velocidad diaria
\[ \textbf{Velocidad} = 1.8 \frac{\text{puntos de historia}}{\text{día}} \]

% Cálculo de horas por sprint
\[ \textbf{Horas por sprint} = 25 \frac{\text{puntos de historia}}{\text{sprint}} \times 2 \frac{\text{h}}{\text{punto de historia}} = 50 \frac{\text{h}}{\text{sprint}} \]

% Cálculo del tiempo total del proyecto
\[ \textbf{Tiempo total del desarrollo} = 50 \frac{\text{h}}{\text{sprint}} \times 5 \text{ sprints} = 250 \text{ h} \]

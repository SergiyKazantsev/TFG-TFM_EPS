	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{|C{3.5cm}|C{3cm}|C{2.5cm}|C{2.5cm}|C{2.5cm}|C{2.5cm}|}
			...
			\textbf{Firebase (Google)} & 
			 ...
			 \cellcolor{red!40} No nativa & \cellcolor{green!20} Alta & \cellcolor{red!20} Baja (Versión gratuita) & 
			 \cellcolor{green!20} Bajo \\ \hline
			
			\textbf{Supabase (Open Source)} & 
			 \cellcolor{gray!10} SQL & 
			 \cellcolor{green!40} Nativa & \cellcolor{green!20} Alta & \cellcolor{green!20} Alta & \cellcolor{green!20} Bajo \\ \hline
		\end{tabular}
	}
